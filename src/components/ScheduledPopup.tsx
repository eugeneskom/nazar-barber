    ...
    return (
        <>
            <div
                ...
                className={`${
                    isOpen
                        ? 'shedule-modal-active overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full flex'
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                                ...
                                {submitData.customerLastName} your appointment
                                is scheduled for {submitData.time}{' '}
                                {String(submitData?.apptDate)}
                            </h3>
                            <button
